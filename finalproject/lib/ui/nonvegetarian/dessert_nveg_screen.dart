...
class DessertNVScreen extends StatefulWidget {
  const DessertNVScreen({super.key});

  @override
  State<DessertNVScreen> createState() => _DessertNVScreenState();
}

class _DessertNVScreenState extends State<DessertNVScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text(AppStrings.titledenv)),
      body: SafeArea(
