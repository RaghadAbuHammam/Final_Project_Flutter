...
class SnackNVScreen extends StatefulWidget {
  const SnackNVScreen({super.key});

  @override
  State<SnackNVScreen> createState() => _SnackNVScreenState();
}

class _SnackNVScreenState extends State<SnackNVScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text(AppStrings.titlesnv)),
      body: SafeArea(
